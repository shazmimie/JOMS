...
if(isset($_POST['cancel'])){
    ...
    $query = "DELETE FROM registration order by registration_id desc limit 1" or die(mysqli_connect_error());
  
  $result = mysqli_query($link, $query);
  
  if($result) 
          {
        echo '<script>window.open("d_login.php", "_self")</script>';
    }
    else 
          {
        echo "fail";
...
<center>
  ...
  <form name="driver" action="d_driver.php" method="post">
<br><br>
    <b><font size = "6"> </font>
...
<div class="row">
   <div class="small-12 medium-2 large-2 columns">
      ...
      <table align="center"> 
       <legend>Click OK button to register Driver Form</legend>
      </table>
   ...
   <input type="submit" type="submit" class="btn btn-default" formaction="d_login.php" value="EXIT" name="cancel"><br><br><br><br><br>
</form>
    </center>
    </div>  
 </div>
