...
$edit = $_GET['a_id'];
$select="select * from announcement where a_id='$edit'";
...
<br><header class="w3-container" style="padding-top:22px">
 ...
 <br><br><br><center><fieldset style="width:1700px"> 
 
  <legend><h1><b>Update Announcement:</b></h1></legend>
<form action="A_updateannouncement.php? a_id=<?php echo $a_id;?>" method="post">
<table>
<tr>
<td><h3>Title:</h3></td>
<td><h4><input type="text" name="a_title"  value="<?php echo $a_title;?>"></h4></td>
</tr>

</tr>
<tr>
<td><h3>Messages:</h3></td>
<td><h4><textarea  name="a_msg"  rows = "10" cols = "100" value="<?php echo $a_msg;?>" ></textarea></h4></td>
</tr>

<tr>
<td><h3>Time:</h3></td>
<td><h4><input type="time" name="a_time"  value="<?php echo $a_time;?>" ></h4></td>
</tr>

<tr>
<td><h3>Date:</h3></td>
<td><h4><input type="date" name="a_date"  value="<?php echo $a_date;?>" ></h4></td>
</tr>


</table>
<a href="A_viewannouncement.php"><input type="submit" name="update" value="Update" ></a>
</form>
...
$update = "update announcement set a_title='$a_title',a_msg='$a_msg',a_time='$a_time',a_date='$a_date' where a_id='$a_id'";

$run_update = mysqli_query($link, $update);

if($run_update)
{
	echo "<script>alert('Record Announcement Update Successfully')</script>";
	echo "<script>window.open('A_home.php','_self')</script>";
}
else
{
