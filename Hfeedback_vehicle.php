...
$sql = "SELECT * FROM vehicle WHERE vehicle_brand='proton'";
if($result = mysqli_query($link, $sql)){
 ...
 $sql = "SELECT * FROM vehicle WHERE vehicle_brand='perodua'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo "<table border=1>";
            echo "<tr>";
...
$sql = "SELECT vehicle_brand, COUNT(vehicle_id) FROM vehicle WHERE vehicle_brand='Proton'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo "<table border=1>";
            echo "<tr>";
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td>" . $row['COUNT(vehicle_id)'] . "</td>";
            echo "</tr>";
        }
        echo "</table>";
        // Free result set
...
$sql = "SELECT vehicle_brand, COUNT(vehicle_id) FROM vehicle WHERE vehicle_brand='perodua'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo "<table border=1>";
            echo "<tr>";
