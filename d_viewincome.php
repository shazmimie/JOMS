...
<center>
   <div class="row">
    <h3>INCOME FOR TODAY</h3>
    <legend>This table is as a reference for your input ID and and Income </legend>
 
           <?php
$link = mysqli_connect("localhost","root","","joms");

$select = "SELECT driver_id,  SUM(price)  from booking GROUP BY driver_id";
...
<br><br>
   <div class="small-12 medium-2 large-2 columns">      
        ...
        <form>
           <label>Please put your ID</label>
          <input type="text" name="driverid" id="driverid"><br>
          <label>Please put your total income</label>
          <input type="text" name="income" id="income"><br>
         
          <center>
     <input type="submit" type="submit" class="btn btn-default" value="YES" name="submit">
     <input type="submit" name="cancel" value="NO" formaction="d_home.php"></center>
  <br><br><br><br><br>
</form>
