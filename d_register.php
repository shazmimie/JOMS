...
<center>
  ...
  <form name="driver" action="d_insert.php" method="post"><br><br><br>
<br><br>
    <b><font size = "6"> Register as Driver</font>
...
<div class="row">
   <div class="small-12 medium-2 large-2 columns">
      ...
      <table> 
        <tr>
          <td>User type  :</td>
          <td><input type="radio" name="usertype" value="student"> Student
      ...
      <input type="radio" name="gender" value="Female">Female</td>
		...
		<tr>
          <td> Username  :</td>
          <td><input type="text" id="dusername" name="dusername"></td>
        </tr>
		
		<tr>
          <td> Password  :</td>
          <td><input type="password" id="dpassword" name="dpassword"></td>
        </tr>
      </table>
  ...
  <br><script>
function myFunction() {
  alert("Congratulations! Your Registration have been approved by Admin");
}
</script>

     <input type="submit" type="submit" class="btn btn-default" value="OK" name="submit" onclick="myFunction()">
   <input type="reset" type="reset" class="btn btn-default" value="RESET" name="cancel"><br><br><br><br><br>
...
$query = "insert into registration values ('','$usertypes','$names','$ages', '$genders', '$phonenumbers', '$emails','$dates','$duser','$dpass')" or die(mysqli_connect_error());
