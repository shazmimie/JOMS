...
$query = "insert into driver values ('','$names', '$ages','$ics', '$genders','$phonenumbers','$emails','$licenses','$add','$statuss','$servis','$duser','$dpass')" or die(mysqli_connect_error());
...
<html>
<head>
	<title>Registration Driver Sucessful</title>
 <meta charset="utf-8">
...
<center>
  ...
  <form name="driver" action="d_home.php" method="post">
<br><br>
    <b><font size = "6"> </font>
...
<div class="row">
   <div class="small-12 medium-2 large-2 columns">
      ...
      <table align="center"> 
       <legend>Congratulations you have successfully registered as a driver</legend>
      </table>
