...
$name2= $_POST['admin_name'];
$phonenum2 = $_POST['admin_phonenum'];
$email2= $_POST['admin_email'];
$username2= $_POST['admin_username'];

$sql = "UPDATE administrator SET admin_name ='$name2',admin_phonenum ='$phonenum2',admin_email ='$email2' WHERE admin_username ='$username2' ";
...
<center>
		<br><br>
		<b><font size = "6">Administrator Profile</font>
...
<form method="post">
			<table>	
				<tr>
					<td><h3>Name  :</h3></td>
					<td><input type="text" name="admin_name" id="admin_name" value="<?php echo $admin_name;?>"></td>
				</tr>
				<tr>
					<td><h3>Phone Number  :</h3></td>
					<td><input type="text" name="admin_phonenum" id="admin_phonenum"  value="<?php echo $admin_phonenum;?>"></td>
					</tr>
				<tr>
					<td><h3>Email  :</h3></td>
					<td><input type="email" name="admin_email" id="admin_email" value="<?php echo $admin_email;?>"></td>
				</tr>
				<tr>
					<td><h3>Username  :</h3></td>
					<td><input type="text" name="admin_username" id="admin_username" readonly value="<?php echo $admin_username;?>"></td>
				</tr>
         

			</table>
			
			<a href="A_retrievepass.php"><h3>Change Password</h3></a> <br>
			
			<a href="A_home.php"><input type="submit"  class="btn btn-default" value="SUBMIT" name="submit"></a>
			
	 <input type="reset" type="reset" class="btn btn-default" value="CANCEL" name="cancel"><br><br><br><br><br>
	 </form>
		</div>	
 </div>
