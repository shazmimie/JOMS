...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    ...
    <center>
       <form name="driver" action="d_insert2.php" method="post">
    <br><br>
...
<div class="row">
   <div class="small-12 medium-2 large-2 columns">
    ...
    <table> <tr>
      ...
      <input type="radio" name="status" value="Not Available">Not Available</td>
        </tr>
        <tr>
          <td>Service  :</td>
          <td><input type="checkbox" name="service" value="Taxi">Taxi
            <input type="checkbox" name="service" value="Rent">Rent
          </td>
          </tr>
  ...
  <br><input type="submit"  type="submit" class="btn btn-default" value="OK" name="submit">
