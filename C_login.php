...
function Redirect()
{
 location.href='C_registration.php' 
 } 
...
$_SESSION['id'] = $username;
  ...
  $message =  "<script language=javascript>  location.href='C_home.php' </script>";
	  }
...
<form name="form"action="" method="POST">
	...
	<br><br><br>
	<center><b><font size = "6"> Customer Login</font></center><br><br><br><br>
...
<center>
    ...
    <br><br><br><br><br><div id="container">
        <form method="post"><br><br>
		    ...
		    <input type="text" class="form-control" id="username" placeholder="Enter username" name="username"></i></span><div>
            
			<span class="input-group-addon"><i class="glyphicon glyphicon-lock">
			
			<label for="password">Password:</label>
			<input type="password" class="form-control" id="password" placeholder="Enter password" name="password"></i></span></div>
           <div id="lower"><br>
			
			 <a href="C_regform.php">New User</a><br>
