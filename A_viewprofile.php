       ...
       <i class="fa fa-camera upload-button"></i>
        <input class="file-upload" type="file" accept="image/*"/>
			...
			<table>	
				<tr>
					<td><h3>Name  :</h3></td>
					<td><input type="text" name="admin_name" id="admin_name" readonly value="<?php echo $admin_name;?>"></td>
				</tr>
				<tr>
					<td><h3>Phone Number  :</h3></td>
					<td><input type="text" name="admin_phonenum" id="admin_phonenum" readonly value="<?php echo $admin_phonenum;?>"></td>
					</tr>
				<tr>
					<td><h3>Email  :</h3></td>
					<td><input type="email" name="admin_email" id="admin_email" readonly value="<?php echo $admin_email;?>"></td>
				</tr>
				<tr>
			...
			<a href="A_updateprofile.php"><input type="submit"  class="btn btn-default" value="EDIT" name="update" formaction="A_updateprofile.php"></a>
