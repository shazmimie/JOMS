...
<br><br>
<br><br><br><header class="w3-container" style="padding-top:22px"><br><br>
...
$sql = "SELECT * FROM booking WHERE type_service='Rent for half day'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo "<table border=1>";
            echo "<tr>";
            echo "RENT FOR HALF DAY";
...
$sql = "SELECT * FROM booking WHERE type_service='Rent for whole day'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo "<table border=1>";
            echo "<tr>";
            echo "RENT FOR WHOLE DAY";
                echo "<th>Booking ID</th>";
                echo "<th>Customer ID</th>";
 ...
 $sql = "SELECT * FROM booking WHERE type_service='Taxi'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo "<table border=1>";
            echo "<tr>";
...
$sql = "SELECT type_service, COUNT(booking_id) FROM booking WHERE type_service='Taxi'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo "<table border=1>";
            echo "<tr>";
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td>" . $row['COUNT(booking_id)'] . "</td>";
            echo "</tr>";
        }
        echo "</table>";
        // Free result set
  ...
  $sql = "SELECT type_service, COUNT(booking_id) FROM booking WHERE type_service='Rent for half day' OR type_service='Rent for whole day'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo "<table border=1>";
            echo "<tr>";
