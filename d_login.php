...
function setFocus()
{
     document.getElementById("dusername").focus();
}

function focusReset(){
		   document.login.dusername.value="";
		   document.login.dpassword.value="";
		   document.login.dusername.focus();
		}

function Blank_Validator()
{
if (document.login.dusername.value == "" ) 
{
     alert("Please fill the user name.");
    document.login.dusername.focus();
  return (false);
}
else  if (document.login.dpassword.value == ""  ){
...
$dpassword = $_REQUEST["dpassword"];

$query="select * from driver where dusername='$dusername' AND dpassword='$dpassword'"
	or die (mysqli_error());
...
if ($count_row > 0) 
  ...
  $message =  "<script language=javascript>  location.href='d_home.php' </script>";
	  }
...
<form name="form"action="" method="POST">
	...
	<br><br><br>
	<center><b><font size = "6"> Driver Login</font></center><br><br><br><br>
...
<center>
    ...
    <br><br><br><br><br><div id="container">
        <form method="post"><br><br>
		    ...
		    <input type="text" class="form-control" id="dusername" placeholder="Enter username" name="dusername"></i></span><div>
            
			<span class="input-group-addon"><i class="glyphicon glyphicon-lock">
			
			<label for="dpassword">Password:</label>
			<input type="password" class="form-control" id="dpassword" placeholder="Enter password" name="dpassword"></i></span></div>
           <div id="lower"><br>
			
			 <a href="d_register.php">New User</a><br>
   	 <input type="submit" type="submit" class="btn btn-default" value="OK" name="submit">
	 <input type="reset" type="reset" class="btn btn-default" value="CANCEL" name="cancel"><br><br>
