...
$name2= $_POST['name'];
$phonenum2 = $_POST['phonenum'];
$email2= $_POST['email'];
$username2= $_POST['username'];
$password2= $_POST['password'];

$sql = "UPDATE customer SET name ='$name2',phonenum ='$phonenum2',email ='$email2',password ='$password2' WHERE username ='$username2' ";
...
if ($run1)
{
	echo "<script language=javascript> 
            alert(\"updATE.\");</script>"; 
			header("location:C_home.php?id=$username");
...
<form method="post">
			<table>	
				...
				<tr>
					...
					<td><input type="text" name="phonenum" id="phonenum"  value="<?php echo $phonenum;?>"></td>
					</tr>
				<tr>
					<td><h3>Email  :</h3></td>
			...
			<a href="C_home.php"><input type="submit"  class="btn btn-default" value="SUBMIT" name="submit"></a>
