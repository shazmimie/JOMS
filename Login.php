...
<a class="navbar-brand" ><href="#editPackage">JOMS</a>
 ...
 <li><a href="HOME.php"><b><h5>HOME</h5></b></a></li>
		  <li><a href="" class="dropdown-toggle" data-toggle="dropdown"><b><h5>FEEDBACK
        ...
        <li><a href="Register.php"><b><h5>REGISTER</h5></b></a></li>
			  <li><a href="Login.php"><b><h5>LOGIN</h5></b></a></li>
...
<center>
  ...
  <form name="form"action="" method="POST"><br><br><br><br><br>
  <p><b><h3>LOGIN AS</h3></b></p>
<br><br><br><br>
<center><h1><b><font size = "6"> </font></b></h1></center><b><br><br>
<button class="button button3" formaction="C_login.php"><h4>CUSTOMER</h4><br><img src="https://cdn4.iconfinder.com/data/icons/eldorado-user/40/user-512.png" width="300" height="150"></a></button>
	<button class="button button3" formaction="d_login.php"><h4>DRIVER</h4><br><img src="https://cdn1.iconfinder.com/data/icons/profession-avatar-1/64/Profession_Job_Profile_People_Avatar-13-512.png" width="300" height="150"></a></button>
	<button class="button button3" formaction="A_login.php"><h4>ADMINISTRATOR</h4><br><img src="https://www.nicepng.com/png/full/438-4388230_profile-user-update-profile-icon-png.png" width="300" height="150"></a></button>
...
<br><br><br><br><br><br><br><br><br><br>
  <div class="w3-container w3-dark-grey w3-padding-32"  style="margin-left:;">
    <div class="w3-row">
      ...
      <div class="w3-container w3-third">
        <h5 class="w3-bottombar w3-border-red">Social Media</h5>
        <p>Facebook</p>
        <p>Instagram</p>
        <p>Twitter</p>
      </div>
      <div class="w3-container w3-third">
        <h5 class="w3-bottombar w3-border-orange">Contact Us</h5>
        <p>Users</p>
        <p>Active</p>
        <p>Geo</p>
        <p>Interests</p>
